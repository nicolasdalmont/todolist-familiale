...
export function CommentThread({ taskId, comments }: { taskId: string; comments: Comment[] }) {
  return (
    <div>
      <h3 className="mb-2.5 mt-5 text-sm font-bold">💬 Commentaires</h3>

      {comments.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-200 py-10 text-center text-sm text-ink-muted">
